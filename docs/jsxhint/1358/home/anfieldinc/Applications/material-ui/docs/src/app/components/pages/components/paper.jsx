...
var PaperPage = React.createClass ({displayName: "PaperPage",
    ...
    return (
      React.createElement(ComponentDoc, {
        ...
        React.createElement("div", null, 
          React.createElement(ClearFix, {style: groupStyle}, 
  ...
  _createParagraphElement: function(text) {
    return React.createElement("p", {style: this.getStyles().p}, text);
  },
